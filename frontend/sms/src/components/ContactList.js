            ...
            {data?.content?.length > 0 && data?.totalPages > 1 &&
                <div className='pagination'>
                    <a 
                      onClick={(e) => { 
                        e.preventDefault(); 
                        if (currentPage > 0) getAllContacts(currentPage - 1); 
                      }} 
                    ...
                    { data && [...Array(data.totalPages).keys()].map((page) => 
                        <a 
                          onClick={(e) => { e.preventDefault(); getAllContacts(page); }} 
                    ...
                    <a 
                      onClick={(e) => { 
                        e.preventDefault(); 
                        if (currentPage < data.totalPages - 1) getAllContacts(currentPage + 1); 
                      }} 
