...
const ContactDetail = ({ updateContact, updateImage }) => {
    ...
    const fetchContact = async (id) => {
        try {
            ...
            setContact(data);
            // toastSuccess('Contact retrieved'); // optional
        } catch (error) {
            console.error(error);
            toastError(error.message || "Failed to fetch contact");
        }
    };
    ...
    const updatePhoto = async (file) => {
        ...
        try {
            ...
            console.error(error);
            toastError(error.message || "Failed to update photo");
        }
    };
    ...
    const onUpdateContact = async (event) => {
        ...
        try {
            ...
            await fetchContact(id); // refresh with latest data
            toastSuccess('Contact updated');
        } catch (error) {
            console.error(error);
            toastError(error.message || "Failed to update contact");
        }
    };
            ...
            <div className='profile'>
                <div className='profile__details'>
                    <img 
                        ...
                        alt={`Profile photo of ${contact.name || "contact"}`} 
                    />
